declare namespace Eps {
	...
	interface KnowledgeBookCategoryEntity {
		/**
		 * ID
		 */
		id?: number;
	...
	interface KnowledgeFilmCategoryEntity {
		/**
		 * ID
		 */
		id?: number;
	...
	interface KnowledgeBookPageResponse {
		pagination: PagePagination;
		list: KnowledgeBookEntity[];
	}

	interface KnowledgeFilmCategoryPageResponse {
		pagination: PagePagination;
		list: KnowledgeFilmCategoryEntity[];
	}

	interface KnowledgeFilmPageResponse {
		pagination: PagePagination;
		list: KnowledgeFilmEntity[];
	}
	...
	interface KnowledgeBook {
		 ...
		 * 代理获取书籍封面，解决防盗链
		 */
		proxycover(data?: any): Promise<any>;
		 ...
		 * 单个信息
		 */
		info(data?: any): Promise<KnowledgeBookEntity>;

		/**
		 * 列表查询
		 */
		list(data?: any): Promise<KnowledgeBookEntity[]>;

		/**
		 * 分页查询
		 */
		page(data?: any): Promise<KnowledgeBookPageResponse>;
	...
	interface KnowledgeFilmCategory {
		/**
		 * 删除
		 */
		delete(data?: any): Promise<any>;
		 ...
		 * 单个信息
		 */
		info(data?: any): Promise<KnowledgeFilmCategoryEntity>;

		/**
		 * 列表查询
		 */
		list(data?: any): Promise<KnowledgeFilmCategoryEntity[]>;

		/**
		 * 分页查询
		 */
		page(data?: any): Promise<KnowledgeFilmCategoryPageResponse>;
	...
	interface KnowledgeFilm {
		 ...
		 * 单个信息
		 */
		info(data?: any): Promise<KnowledgeFilmEntity>;

		/**
		 * 列表查询
		 */
		list(data?: any): Promise<KnowledgeFilmEntity[]>;

		/**
		 * 分页查询
		 */
		page(data?: any): Promise<KnowledgeFilmPageResponse>;
	...
	type Service = {
		...
		knowledge: {
			...
			book: KnowledgeBook;
			filmCategory: KnowledgeFilmCategory;
			film: KnowledgeFilm;
		};
